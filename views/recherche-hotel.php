...
require 'config.php';
require 'controllers/RechercheHotelController.php';
require 'functions.php';

$hotelLocation = isset($_GET['hotel_location']) ? $_GET['hotel_location'] : '';
...
$controller = new RechercheHotelController($model);

$result = $controller->rechercherHotels($hotelLocation, $pageno, $noOfRecordsPerPage);
