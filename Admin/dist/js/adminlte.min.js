...
+(function (a) {
    ...
    (h.prototype.toggle = function () {
      ...
      (h.prototype.expand = function () {
        ...
        a(this.element).removeClass(f.collapsed),
          a(this.element)
            .children(e.header + ", " + e.body + ", " + e.footer)
            .children(e.tools)
            .find("." + d)
            .removeClass(d)
            .addClass(c),
          a(this.element)
            .children(e.body + ", " + e.footer)
            .slideDown(
    ...
    (g.prototype.activate = function () {
      ...
      (g.prototype.fix = function () {
        ...
        if (a("body").hasClass(f.fixed))
          a(e.contentWrapper).css("min-height", g - b);
        else {
          var i;
          g >= h
            ? (a(e.contentWrapper).css("min-height", g - d), (i = g - d))
            : (a(e.contentWrapper).css("min-height", h), (i = h));
          var j = a(e.controlSidebar);
          void 0 !== j &&
            j.height() > i &&
            a(e.contentWrapper).css("min-height", j.height());
        }
      }),
      (g.prototype.fixSidebar = function () {
        if (!a("body").hasClass(f.fixed))
          return void (
            ...
            a(e.sidebar).slimScroll({ destroy: !0 }).height("auto")
          );
        this.options.slimscroll &&
          void 0 !== a.fn.slimScroll &&
          a(e.sidebar).slimScroll({
  ...
  (function (a) {
    ...
    (h.prototype.init = function () {
      (this.options.expandOnHover || a("body").is(e.mini + e.layoutFixed)) &&
        (this.expandOnHover(), a("body").addClass(f.expandFeature)),
      ...
      (h.prototype.open = function () {
        a(window).width() > this.options.collapseScreenSize
          ? a("body").removeClass(f.collapsed).trigger(a.Event(g.expanded))
          : a("body").addClass(f.open).trigger(a.Event(g.expanded));
      }),
  ...
  (function (a) {
    ...
    (g.prototype.toggle = function (a) {
      if ((a.parents(e.li).first().toggleClass(f.done), !a.prop("checked")))
