...
(function ($, undefined) {
  ...
  Datepicker.prototype = {
    ...
    getClassNames: function (date) {
      ...
      if (this.focEURate && date.valueOf() === this.focEURate.valueOf())
        cls.push("focused");
    ...
    keydown: function (e) {
      ...
      var dateChanged = false,
        ...
        newDate,
        newViewDate,
        focEURate = this.focEURate || this.viewDate;
      switch (e.keyCode) {
        case 27: // escape
          if (this.focEURate) {
            this.focEURate = null;
        ...
        case 39: // right
          ...
          if (e.ctrlKey) {
            ...
            newViewDate = this.moveYear(focEURate, dir);
            this._trigger("changeYear", this.viewDate);
          } else if (e.shiftKey) {
            newDate = this.moveMonth(this.dates.get(-1) || UTCToday(), dir);
            newViewDate = this.moveMonth(focEURate, dir);
            this._trigger("changeMonth", this.viewDate);
          } else {
            newDate = new Date(this.dates.get(-1) || UTCToday());
            newDate.setUTCDate(newDate.getUTCDate() + dir);
            newViewDate = new Date(focEURate);
            newViewDate.setUTCDate(focEURate.getUTCDate() + dir);
          }
          if (this.dateWithinRange(newDate)) {
            this.focEURate = this.viewDate = newViewDate;
            this.setValue();
            this.fill();
            e.preventDefault();
          }
        ...
        case 40: // down
          ...
          if (e.ctrlKey) {
            ...
            newViewDate = new Date(focEURate);
            newViewDate.setUTCDate(focEURate.getUTCDate() + dir * 7);
          }
          if (this.dateWithinRange(newDate)) {
            this.focEURate = this.viewDate = newViewDate;
            this.setValue();
        ...
        case 32: // spacebar
          ...
          break;
        case 13: // enter
          focEURate = this.focEURate || this.dates.get(-1) || this.viewDate;
          this._toggle_multidate(focEURate);
          dateChanged = true;
          this.focEURate = null;
          this.viewDate = this.dates.get(-1) || this.viewDate;
          this.setValue();
